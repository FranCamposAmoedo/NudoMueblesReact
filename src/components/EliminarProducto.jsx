...
function EliminarProducto() {
    ...
    const eliminarProducto = async () => {
        ...
        try {
            const respuesta = await
                fetch(`https://68eebe3bb06cc802829b37bf.mockapi.io/api/productos/${producto.id}`, {
                    method: 'DELETE',
                });
    ...
    return (
        <div style={{ maxWidth: '500px', margin: '40px auto', padding: '3rem', paddingTop: '150px', textAlign: 'center' }}>
